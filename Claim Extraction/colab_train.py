...
# Copy code này vào Colab notebook
...
# Upload contextualized_claims.csv to Colab first
df = pd.read_csv("/content/contextualized_claims.csv")  # Colab path
...
training_args = Seq2SeqTrainingArguments(
    ...
    save_strategy="epoch",
    learning_rate=3e-5,
    per_device_train_batch_size=2,  # Colab T4 can handle this
...
import shutil
shutil.make_archive("vit5-contextualize-claim", 'zip', "./vit5-contextualize-claim")
files.download("vit5-contextualize-claim.zip")
