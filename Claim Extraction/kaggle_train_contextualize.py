...
df = pd.read_csv("/kaggle/input/contextualized-claims/contextualized_claims.csv")  # Kaggle path
...
training_args = Seq2SeqTrainingArguments(
    ...
    save_strategy="epoch",
    learning_rate=3e-5,
    per_device_train_batch_size=1,  # Very small for Kaggle
    per_device_eval_batch_size=1,    # Very small for Kaggle
